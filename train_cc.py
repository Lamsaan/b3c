...
def train_single(data, cur_epoch, n_clusters, lamb=10.0, beta=0.01):
    ...
    # tqdm.write(
    #     "Epoch: {}, training loss={:.5f}, adj loss={:.5f}, fea loss={:.5f}, kl loss={:.5f}".format(cur_epoch + 1, loss,
    #                                                                                                adj_loss,
    #                                                                                                fea_loss,
    #                                                                                                kl_loss))
...
def train_cc(data1, data2, cc, kl_epochs, lr, n_clusters, device, bipart=None, lamb=10.0, beta=0.01, gamma=0.01):
    ...
    with open("ACM_best_l_"+str(lamb)+"_b_"+str(beta)+"_g_"+str(gamma), 'a') as f:
        f.write(str(best_acc_1) + " " + str(best_f1_1) + " " + str(best_nmi_1) + " " + str(best_ari_1) + "\n")
        f.write(str(best_acc_2) + " " + str(best_f1_2) + " " + str(best_nmi_2) + " " + str(best_ari_2) + "\n")

    with open("ACM_last_l_"+str(lamb)+"_b_"+str(beta)+"_g_"+str(gamma), 'a') as f:
        f.write(str(acc_1) + " " + str(f1_1) + " " + str(nmi_1) + " " + str(ari_1) + "\n")
        f.write(str(acc_2) + " " + str(f1_2) + " " + str(nmi_2) + " " + str(ari_2) + "\n")
